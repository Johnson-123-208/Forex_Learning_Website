    ...
    lessons: [
      ...
      },
      {
        ...
        content: `
          ...
          <div style="background:#f9f9f9; padding:15px; margin:20px 0; border-left:4px solid #2563eb;">
    ...
    lessons: [
      {
        ...
        content: `
          ...
          <div style="background:#f9f9f9; padding:15px; margin:20px 0; border-left:4px solid #16a34a;">
  ...
  lessons: [
    {
      ...
      content: `
          <img src="https://images.unsplash.com/photo-1611974717482-959aa9960b4f?auto=format&fit=crop&q=80&w=1000" alt="Market Analysis" style="width:100%; border-radius:12px; margin-bottom:20px; box-shadow: 0 4px 20px rgba(0,0,0,0.3);" />
  ...
  lessons: [
    {
      ...
      content: `
          <img src="https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?auto=format&fit=crop&q=80&w=1000" alt="Market Analysis" style="width:100%; border-radius:12px; margin-bottom:20px; box-shadow: 0 4px 20px rgba(0,0,0,0.3);" />
  ...
  lessons: [
    {
      ...
      content: `
          <img src="https://images.unsplash.com/photo-1535320903710-d993d3d77d29?auto=format&fit=crop&q=80&w=1000" alt="Market Analysis" style="width:100%; border-radius:12px; margin-bottom:20px; box-shadow: 0 4px 20px rgba(0,0,0,0.3);" />
  ...
  lessons: [
    {
      ...
      content: `
          <img src="https://images.unsplash.com/photo-1642790106117-e829e14a795f?auto=format&fit=crop&q=80&w=1000" alt="Market Analysis" style="width:100%; border-radius:12px; margin-bottom:20px; box-shadow: 0 4px 20px rgba(0,0,0,0.3);" />
  ...
  lessons: [
    {
      ...
      content: `
          <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=1000" alt="Market Analysis" style="width:100%; border-radius:12px; margin-bottom:20px; box-shadow: 0 4px 20px rgba(0,0,0,0.3);" />
  ...
  lessons: [
    {
      ...
      content: `
          <img src="https://images.unsplash.com/photo-1504711432814-07d400938682?auto=format&fit=crop&q=80&w=1000" alt="Market Analysis" style="width:100%; border-radius:12px; margin-bottom:20px; box-shadow: 0 4px 20px rgba(0,0,0,0.3);" />
  ...
  lessons: [
    {
      ...
      content: `
          <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=1000" alt="Market Analysis" style="width:100%; border-radius:12px; margin-bottom:20px; box-shadow: 0 4px 20px rgba(0,0,0,0.3);" />
  ...
  lessons: [
    {
      ...
      content: `
          <img src="https://images.unsplash.com/photo-1507413245164-6160d8298b31?auto=format&fit=crop&q=80&w=1000" alt="Market Analysis" style="width:100%; border-radius:12px; margin-bottom:20px; box-shadow: 0 4px 20px rgba(0,0,0,0.3);" />
    ...
    lessons: [
      {
        ...
        content: `
          <img src="https://images.unsplash.com/photo-1591696208162-a93c12643a6d?auto=format&fit=crop&q=80&w=1000" alt="Market Analysis" style="width:100%; border-radius:12px; margin-bottom:20px; box-shadow: 0 4px 20px rgba(0,0,0,0.3);" />
    ...
    lessons: [
      {
        ...
        content: `
          <img src="https://images.unsplash.com/photo-1518186239747-4f8101683907?auto=format&fit=crop&q=80&w=1000" alt="Market Analysis" style="width:100%; border-radius:12px; margin-bottom:20px; box-shadow: 0 4px 20px rgba(0,0,0,0.3);" />
Institutional-grade introduction to building Python bots using CCXT, Pandas, Backtrader/PyAlgoTrade, and risk engines specifically designed for prop firm rule compliance... (680 words)`,
        quiz: [/* questions */]
      },
      {
        id: "15.2",
    ...
    lessons: [
      {
        ...
        content: `
          <img src="https://images.unsplash.com/photo-1553484771-047a44eee27b?auto=format&fit=crop&q=80&w=1000" alt="Market Analysis" style="width:100%; border-radius:12px; margin-bottom:20px; box-shadow: 0 4px 20px rgba(0,0,0,0.3);" />
Complete tactical guide to passing FTMO with the strategies from Module 13, exact risk parameters, trade frequency targets, and psychological framework...`,
        quiz: [/* questions */]
      },
      {
        id: "16.2",
